  ...
  "scenes": [
    {
      ...
      "chapterCard": { "index": 1, "total": 3, "title": "실시간 배차" },        // 씬 시작 1.5초 전환 카드
      "beats": [
    ...
    { "id": "ch9-end", "title": "엔드스크린", "anchor": { "fromSentence": 86, "toSentence": 87 }, "layout": "face-main", "endScreen": true, "beats": [], "keywords": [] }
  ],
